...
if has("win32")
    ...
    augroup end
    map <leader>o :FZF<CR>
    map <leader>up :silent !adb push % /storage/emulated/0/Android/data/com.mycompany.xxx/files/%:.:gs?\\?/?<CR>
    map <leader>rm :silent !adb shell rm /storage/emulated/0/Android/data/com.mycompany.xxx/files/%:.:gs?\\?/?<CR>
    map <leader>re :silent !adb shell am start -S -n com.mycompany.xxx/com.unity3d.player.UnityPlayerActivity<CR>
    nmap <M-c> <C-C><C-W>c
    " 打开当前目录 windows
